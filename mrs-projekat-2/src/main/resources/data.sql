...
insert into employee(birthday,shoe_size,uniform_size,id,restaurant_id, enabled) value (null,43,31,6,1, true)
...
insert into employee(birthday,shoe_size,uniform_size,id,restaurant_id, enabled) value (null,43,31,7,1,true)
...
insert into employee(birthday,shoe_size,uniform_size,id,restaurant_id, enabled) value (null,43,31,8,1, true)
