...
insert into meal(id, description, name, price, restaurant_id,deleted) value (1,"Testenine","Spagete",380,1,0)
insert into meal(id, description, name, price, restaurant_id,deleted) value (2,"Supe i corbe","Teleca Corba",260,1,0)
insert into meal(id, description, name, price, restaurant_id,deleted) value (3,"Supe i corbe","Kokosja Supa",160,1,0)
insert into meal(id, description, name, price, restaurant_id,deleted) value (4,"Supe i corbe","Krem supa",220,1,0)
insert into meal(id, description, name, price, restaurant_id,deleted) value (5,"Salate","Grcka salata",430,1,0)
insert into meal(id, description, name, price, restaurant_id,deleted) value (6,"Testenine","Carbonara",500,1,0)
insert into drink(id, description, name, price, restaurant_id,deleted) value (1,"Viski","Jack Daniel's",220,1,0)
insert into drink(id, description, name, price, restaurant_id,deleted) value (2,"Viski","Johnny Walker",180,1,0)
insert into drink(id, description, name, price, restaurant_id,deleted) value (3,"Gazirani sokovi","Coca-Cola",150,1,0)
insert into drink(id, description, name, price, restaurant_id,deleted) value (4,"Gazirani sokovi","Sprite",150,1,0)
insert into drink(id, description, name, price, restaurant_id,deleted) value (5,"Kafa","Espresso",110,1,0)
insert into drink(id, description, name, price, restaurant_id,deleted) value (6,"Kafa","Cappuccino",150,1,0)
